    ...
    <div class="p-6 max-w-7xl mx-auto mt-4">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div>
                <h1
                    ...
                    <i class="fa-solid fa-file-pen text-orange-500"></i> รายการยื่นแก้ไขโครงงาน (กรรมการ)
                </h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 transition-colors duration-200">
                    ตรวจสอบและพิจารณาอนุมัติการแก้ไขเอกสารโครงงานของนักศึกษา
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div
                ...
                <form method="GET" action="{{ route('invigilator.revision.index') }}" id="filterForm"
