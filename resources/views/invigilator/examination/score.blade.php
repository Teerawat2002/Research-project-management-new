    ...
    <div class="p-6 max-w-7xl mx-auto mt-4">
        ...
        <form action="{{ route('invigilator.examination.save', ['id' => $examsubmission->id]) }}" method="POST"
            ...
            <div
                ...
                <div class="overflow-x-auto mt-1.5 pb-24">
                                            ...
                                            <td class="px-4 py-4 text-center align-middle">
                                                ...
                                                <div x-data="{
                                                    ...
                                                    <div x-show="open" style="display: none;" x-transition.opacity
                                                        class="absolute top-full mt-2 w-[180px] p-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] flex flex-wrap gap-1 justify-center z-50">
                                                        <div
                                                ...
                                                @foreach ($groupMembers as $gm)
                                                    <td class="px-4 py-3 text-center align-middle">
                                                        ...
                                                        <div x-data="{
                                                            ...
                                                            setValue(val) { $refs.inputField.value = val;
                                                                $refs.inputField.dispatchEvent(new Event('input'));
                                                                this.open = false; }
                                                        }"
                                                            class="relative flex justify-center items-center"
