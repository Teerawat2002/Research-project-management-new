    ...
    <div class="p-6 max-w-5xl mx-auto mt-4">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div class="flex-1 min-w-0 pr-4">
                <h1
                    ...
                    <i class="fa-solid fa-calendar-check text-orange-500 shrink-0"></i> ตารางกำหนดการสอบ
                </h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div
                            ...
                            <div
                                ...
                                <span class="text-[10px] font-bold text-orange-500 uppercase">
                                    {{ $submission->e_date?->format('M') ?? '-' }}
                                </span>
                                <span class="text-lg font-bold text-gray-800 dark:text-white leading-none">
                                    {{ $submission->e_date?->format('d') ?? '-' }}
                                </span>
                            </div>
                            <div>
                                ...
                                <p class="text-base font-bold text-gray-800 dark:text-white">
                                    {{ $submission->e_date?->format('d-m-Y') ?? 'ยังไม่ระบุวันที่' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-base font-bold text-gray-800 dark:text-white">
                                    {{ $submission->e_time ? $submission->e_time->format('H:i') . ' น.' : 'ยังไม่ระบุเวลา' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                class="w-12 h-12 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center shadow-sm shrink-0 border border-orange-100 dark:border-orange-700 text-orange-500">
            ...
            <div class="lg:col-span-1">
                <div
                    class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors duration-200 h-full">
                    <h3
                            ...
                            @foreach ($submission->exam_invi_members as $member)
                                ...
                                <li
                                    ...
                                    <div class="flex flex-col min-w-0">
                                        ...
                                        <span class="text-[10px] text-gray-500 uppercase">กรรมการคุมสอบ</span>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
