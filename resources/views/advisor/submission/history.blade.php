        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div class="flex-1 min-w-0 pr-4">
                <h1
                    ...
                    <i class="fa-solid fa-clock-rotate-left text-orange-500 shrink-0"></i> ประวัติการยื่นสอบ
                </h1>
        ...
        <div
            ...
            @if ($history->isEmpty())
                <div class="text-center py-16">
                    ...
                    <h3 class="text-lg font-bold text-gray-700 dark:text-gray-300 mb-1">ไม่พบประวัติการยื่นสอบ</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        โครงงานนี้ยังไม่เคยถูกบันทึกผลการตรวจสอบการยื่นสอบ</p>
                </div>
            @else
                    ...
                    @foreach ($history as $record)
                        <div class="relative pl-6 md:pl-8 group">
                            ...
                            @elseif ($record->status === 'pending')
                                <div
                                    class="absolute -left-[17px] top-1 w-8 h-8 rounded-full bg-amber-100 dark:bg-amber-500/20 border-4 border-white dark:border-gray-800 flex items-center justify-center text-amber-500 dark:text-amber-400 shadow-sm ring-1 ring-gray-100 dark:ring-gray-700">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        @elseif ($record->status === 'rejected')
                                            <span
                                                ...
                                                <i class="fa-solid fa-circle-xmark mr-1.5"></i> ถูกปฏิเสธ / ส่งแก้ไข
                                            </span>
                                        @elseif ($record->status === 'pending')
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400">
                                                <i class="fa-solid fa-clock mr-1.5"></i> รอดำเนินการ
                                            </span>
                                        @else
                                            <span
                                    ...
                                    <div
                                        class="text-xs font-medium text-gray-500 dark:text-gray-400 flex items-center gap-1.5 bg-white dark:bg-gray-800 px-3 py-1 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
