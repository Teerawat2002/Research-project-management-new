        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div class="flex-1 min-w-0 pr-4">
                <h1
                    ...
                    <i class="fa-solid fa-calendar-check text-orange-500 shrink-0"></i> รายละเอียดตารางสอบ
                </h1>
            ...
            <div class="flex shrink-0 gap-3">
                ...
                @if ($submission->status != 5)
                    <a href="{{ route('advisor.schedule.edit', $submission->id) }}"
                        class="shrink-0 whitespace-nowrap px-4 py-2 bg-orange-500 text-white rounded-xl hover:bg-orange-600 shadow-sm shadow-orange-500/20 transition-colors flex items-center gap-2 text-sm font-medium">
                        <i class="fa-solid fa-pen-to-square"></i> แก้ไขตารางสอบ
                    </a>
                @endif
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-base font-bold text-gray-800 dark:text-white">
                                    {{ optional($submission->e_date)->format('d-m-Y') ?? '-' }}</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-base font-bold text-gray-800 dark:text-white">
                                    {{ $submission->e_time->format('H:i') ?? '-' }} น.</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-800 dark:text-white">
                                    {{ $submission->e_room ?? 'ยังไม่ระบุสถานที่' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
