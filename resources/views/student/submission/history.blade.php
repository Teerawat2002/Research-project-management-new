        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div class="flex-1 min-w-0 pr-4">
                <h1
                    ...
                    <i class="fa-solid fa-clock-rotate-left text-orange-500 shrink-0"></i> ประวัติการพิจารณาขอสอบ
                </h1>
                ...
                <table class="w-full text-sm text-left text-gray-600 dark:text-gray-400 transition-colors duration-200">
                    <thead
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 font-semibold min-w-[300px]">
                                ความคิดเห็นจากอาจารย์/กรรมการ</th>
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex flex-col">
                                        <span class="text-sm font-bold text-gray-800 dark:text-gray-200">
                                            {{ \Carbon\Carbon::parse($record->created_at)->timezone('Asia/Bangkok')->format('d/m/Y') }}
                                        </span>
                                        <span
                                            class="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                            เวลา
                                            {{ \Carbon\Carbon::parse($record->created_at)->timezone('Asia/Bangkok')->format('H:i') }}
                                            น.
                                        </span>
                                    </div>
                                </td>
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-16 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-base font-medium">ยังไม่มีประวัติการพิจารณาขอสอบโครงงานนี้</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
