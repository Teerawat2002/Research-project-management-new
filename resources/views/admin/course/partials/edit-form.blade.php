<form id="editCourseForm" method="POST" action="" class="p-6 transition-colors duration-200">
    @csrf
    @method('PUT')
    ...
    <div class="mb-6">
        ...
        <div class="flex">
            ...
            <input type="text" id="edit_name" name="name" required
                ...
                placeholder="เช่น โครงงานเทคโนโลยีสารสนเทศ 1">
        </div>
    </div>
    ...
    <div class="flex items-center justify-end gap-3">
        <button type="button" data-modal-hide="editCourseModal"
