<form id="createProjectTypeForm" method="POST" action="{{ route('admin.project-type.store') }}"
    ...
    <div class="mb-6">
        <label for="name"
            ...
            ชื่อประเภทโครงงานวิจัย <span class="text-red-500 dark:text-red-400">*</span>
        </label>
        <div class="flex">
            <span
            ...
            <input type="text" id="name" name="name" required
                ...
                placeholder="เช่น Web Application" value="{{ old('name') }}">
        </div>
        @error('name')
    ...
    <div class="flex items-center justify-end gap-3">
        <button type="button" data-modal-hide="createProjectTypeModal"
