<form id="editSubTopicForm" method="POST" action="" class="p-6 transition-colors duration-200">
    @csrf
    @method('PUT')
    ...
    <div class="mb-5">
        ...
        <input type="hidden" name="mtopic_id" id="edit_mtopic_id" required>
        ...
        <div class="flex shadow-sm rounded-xl w-full">
            ...
            <div class="relative flex-1 min-w-0">
                <button type="button" id="editDropdownBtn" data-dropdown-toggle="editDropdownMenu"
                    ...
                    <span id="editDropdownText" class="truncate flex-1 text-left pr-2">เลือกหัวข้อหลัก</span>
                ...
                <div id="editDropdownMenu"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="editDropdownBtn">
                        @foreach ($main_topics as $main_topic)
                            <li>
                                <a href="#"
                                    onclick="event.preventDefault(); document.getElementById('edit_mtopic_id').value='{{ $main_topic->id }}'; document.getElementById('editDropdownText').innerText='{{ addslashes($main_topic->name) }}'; document.getElementById('editDropdownBtn').click();"
    ...
    <div class="mb-5">
        ...
        <div class="flex shadow-sm rounded-xl w-full">
            ...
            <input type="text" id="edit_name" name="name" required
                ...
                placeholder="เช่น ส่วนหน้าบ้าน (Frontend)">
        </div>
        @error('name')
            <p class="text-red-500 dark:text-red-400 text-sm mt-1.5">{{ $message }}</p>
        @enderror
    ...
    <div class="flex items-center justify-end gap-3">
        <button type="button" data-modal-hide="editSubTopicModal"
