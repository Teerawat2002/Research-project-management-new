<form id="createMainTopicForm" method="POST" action="{{ route('admin.topic.maintopic.store') }}"
    ...
    <div class="mb-4">
        ...
        <input type="text" id="name" name="name" required
            ...
            placeholder="เช่น โครงสร้างระบบ" value="{{ old('name') }}">
        @error('name')
    ...
    <div class="flex items-center justify-end gap-3">
        <button type="button" data-modal-hide="createMainTopicModal"
