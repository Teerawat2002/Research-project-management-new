<form id="createMajorForm" method="POST" action="{{ route('admin.major.store') }}"
    ...
    <div class="mb-6">
        ...
        <div class="flex">
            ...
            <input type="text" id="m_name" name="m_name" required
                ...
                placeholder="เช่น Computer Science" value="{{ old('m_name') }}">
        </div>
    </div>
    ...
    <div class="flex items-center justify-end gap-3">
        <button type="button" data-modal-hide="createMajorModal"
